...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Observer": () => (/* binding */ observer_default),
...
var tailwindcss_intersect_1 = __webpack_require__(/*! tailwindcss-intersect */ "./node_modules/tailwindcss-intersect/dist/index.esm.js");
tailwindcss_intersect_1.Observer.start();
updateSelectedItems();
...
var detailsElement = document.getElementById('specialties-details');
...
detailsElement === null || detailsElement === void 0 ? void 0 : detailsElement.addEventListener('change', updateSelectedItems);
function updateSelectedItems() {
    if (!detailsElement || !selectedItemsContainer)
        return;
    var checkedInputs = detailsElement.querySelectorAll('input[type="checkbox"]:checked');
    var selectedItems = Array.from(checkedInputs).map(function (input) { var _a; return ((_a = input.nextElementSibling) === null || _a === void 0 ? void 0 : _a.textContent) || ''; });
    selectedItemsContainer.innerHTML =
        selectedItems.length > 0
            ? selectedItems.map(function (item) { return "<p>".concat(item, "</p>"); }).join('')
            : '';
}
...
window.addEventListener('scroll', function () {
    ...
    if (window.scrollY > 100) {
        scrollTopButton === null || scrollTopButton === void 0 ? void 0 : scrollTopButton.classList.add('show');
        statsButton === null || statsButton === void 0 ? void 0 : statsButton.classList.add('show');
    }
    else {
        scrollTopButton === null || scrollTopButton === void 0 ? void 0 : scrollTopButton.classList.remove('show');
        statsButton === null || statsButton === void 0 ? void 0 : statsButton.classList.remove('show');
    }
});
scrollTopButton === null || scrollTopButton === void 0 ? void 0 : scrollTopButton.addEventListener('click', function () {
    scrollTopButton.classList.remove('show');
    window.scrollTo({ top: 0, behavior: 'smooth' });
});
var openSidebarButton = document.getElementById('open-sidebar-menu');
var closeSidebarButton = document.getElementById('close-sidebar-menu');
